...
class ChangeEmailController extends AuthorizedController {
	...
	public function postIndex()
	{
		...
		if ( ! $user->checkPassword(Input::get('current_password')))
		{
			...
			$this->messageBag->add('current_password', 'Email hiện tại của bạn không chính xác.');
		...
		return Redirect::route('change-email')->with('success', 'Cập nhật email mới thành công!');
	}
