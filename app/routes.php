...
Route::get('star',array('uses'=>'StarController@users'));
...
Route::resource('thanhvien', 'MemberController');

Route::get('lienhe', array('as' => 'contact-us', 'uses' => 'ContactController@getIndex'));
Route::post('lienhe', 'ContactController@postIndex');

Route::get('blog/{postSlug}', array('as' => 'view-post', 'uses' => 'BlogController@getView'));
Route::post('blog/{postSlug}', 'BlogController@postView');

Route::get('/blog', array('as' => 'home', 'uses' => 'BlogController@getIndex'));
